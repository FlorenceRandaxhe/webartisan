...
/*
    Template Name: Jobs
*/
$jobs = new WP_Query(['post_type'=>'emplois', 'order'=>'DESC', 'order_by'=>'date', 'showposts' => 6,]);
job_filter( $jobs );
get_header();
?>
                ...
                <div class="jobs__container" id="job_search">
                    ...
                    <div class="section__jobs__content">
                        <div class="jobs__filter">
                            <form action="#job_search" method="get">
                                <!--<div>
                                    <label for="skills" class="form__label form__label--block">Compétences</label>
                                    <input type="text" name="skills" id="skills" class="input--wide" value="<?/*= $_GET['skills']; */?>">
                                </div>-->
                                <div>
                    ...
                    <?php if ($jobs->have_posts()) :?>
                        ...
                        <?php while ($jobs->have_posts()) : $jobs->the_post(); ?>
                            <div class="job">
                                <a href="<?php the_field('url'); ?>" class="job__link">
